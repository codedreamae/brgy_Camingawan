...
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'leader') { // Fixed condition
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo "<script>alert('Your appointment request has been sent!'); window.location.href='purokredent.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
fetchNotifications();
        ...
        <li class="nav-item">
          <a class="nav-link active" data-bs-toggle="tooltip" data-bs-target="custom-tooltip" data-bs-placement="right" title="Mga Listahan sang mga Pumuloyo " aria-current="page" href="lead.php">Resident</a>
        </li>
        <li class="nav-item">
